...
global.gp[6] = ini_read_real("Gamepad", "item select", gp_shoulderr);
global.gp[7] = ini_read_real("Gamepad", "item cancel", gp_face4);
global.gp[8] = ini_read_real("Gamepad", "pause", gp_start);

global.gp_m[0] = ini_read_real("Gamepad", "menu select", gp_face1);
global.gp_m[1] = ini_read_real("Gamepad", "menu cancel", gp_face2);
global.gp_m[2] = ini_read_real("Gamepad", "menu next", gp_shoulderrb);
global.gp_m[3] = ini_read_real("Gamepad", "menu previous", gp_shoulderlb);
ini_close();
