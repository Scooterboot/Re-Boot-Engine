...
part_type_life(explosion[1],17,17);
...
part_type_life(explosion[2],17,17);
...
part_type_life(npcDeath[1],15,15);



npcDeath[2] = part_type_create();
part_type_sprite(npcDeath[2],sprt_EnemyDeath1,true,true,false);
part_type_life(npcDeath[2],15,15);
part_type_direction(npcDeath[2],135,135,0,0);
part_type_orientation(npcDeath[2],0,0,0,0,0);
part_type_speed(npcDeath[2],4,4,-0.25,0);

npcDeath[3] = part_type_create();
part_type_sprite(npcDeath[3],sprt_EnemyDeath1,true,true,false);
part_type_life(npcDeath[3],15,15);
part_type_direction(npcDeath[3],45,45,0,0);
part_type_orientation(npcDeath[3],270,270,0,0,0);
part_type_speed(npcDeath[3],4,4,-0.25,0);

npcDeath[4] = part_type_create();
part_type_sprite(npcDeath[4],sprt_EnemyDeath1,true,true,false);
part_type_life(npcDeath[4],15,15);
part_type_direction(npcDeath[4],225,225,0,0);
part_type_orientation(npcDeath[4],90,90,0,0,0);
part_type_speed(npcDeath[4],4,4,-0.25,0);

npcDeath[5] = part_type_create();
part_type_sprite(npcDeath[5],sprt_EnemyDeath1,true,true,false);
part_type_life(npcDeath[5],15,15);
part_type_direction(npcDeath[5],315,315,0,0);
part_type_orientation(npcDeath[5],180,180,0,0,0);
...
part_type_life(npcDeath[6],16,16);
part_type_direction(npcDeath[6],45,135,0,0);
part_type_speed(npcDeath[6],6,8,-0.25,0);
part_type_gravity(npcDeath[6],.9,270);
