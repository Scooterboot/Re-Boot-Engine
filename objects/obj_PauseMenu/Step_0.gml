			...
			if(!confirmRestart && !confirmQuitMM && !confirmQuitDT)
			{
				...
				if(select)
				{
					...
					switch(optionPos)
					{
						case 0:
						{
							instance_create_depth(0,0,depth-1,obj_DisplayOptions);
							break;
						}
						case 1:
						{
							instance_create_depth(0,0,depth-1,obj_AudioOptions);
							break;
						}
						case 2:
						{
							instance_create_depth(0,0,depth-1,obj_ControlOptions);
							break;
						}
						case 3:
						{
