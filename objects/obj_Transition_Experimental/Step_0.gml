...
else
{
    ...
    if(nextDoor != noone)
    {
		...
		//{
			obj_Camera.x = nextDoor.x + screenPosX + lengthdir_x(/*global.resWidth/2*/spawnDist, nextDoor.image_angle) - (global.resWidth/2);
			obj_Camera.y = nextDoor.y + screenPosY + lengthdir_y(/*global.resHeight/2*/spawnDist, nextDoor.image_angle) - (global.resHeight/2);
